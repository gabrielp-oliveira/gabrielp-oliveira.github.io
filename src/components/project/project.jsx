    ...
    return (
        <div className="proj">
            ...
            <div className="proj-info">
                ...
                <img className="img" src={data.info.img} alt="" />
                <div className="proj-buttons">
      
                    <a href={data.info.urls.visit}><button><FontAwesomeIcon icon={faDesktop}/></button></a>
                    <a href={data.info.urls.code}><button><FontAwesomeIcon icon={faGithub}/></button></a>
                    <a href={data.info.urls.details}><button><FontAwesomeIcon icon={faSearch}/></button></a>
                </div>
