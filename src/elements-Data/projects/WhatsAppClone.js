...
export default  {
    eng:{
        ...
        features: <span  className="black">in addition to the <span className="target">messaging</span> functionality, we also store this information in a <span className="target">database</span>  that can be accessed at any time.</span>,
    },
    pt:{
        ...
        features: <span  className="black"> alem das funcionalidades de <span className="target">troca de mensagens</span>, tambem armazenamos essas informações em um <span className="target">banco de dados</span> que poderão ser acessadas a qualquer momento.</span>,
