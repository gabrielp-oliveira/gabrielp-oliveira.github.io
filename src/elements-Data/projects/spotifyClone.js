...
export default  {
    eng:{
        ...
        function:<span>having user {<span className="target">authentication functionality</span>}, it is possible to obtain the {<span className="target" >user's</span>} playlists, with their music, authors and albums.</span>,
        features: [
    ...
    pt:{
        ...
        function: <span>possuindo as {<span className="target">funcionalidades de autenticação</span>} de usuario, é possivel obter as playlists do {<span className="target">usuario</span>}, com suas musicas, autores e albums.</span>,
